...
(function() {
  var ActiveBallState, BALL_ANIMATION_FPS, BALL_ANIMATION_FRAME_COUNT, BALL_COLORS, BALL_SIZE, Ball, BallGrid, COL_COUNT, GRID_SIZE, GameState, LINE_COUNT, UsualBallState;
  ...
  BallGrid = (function() {
    ...
    BallGrid.prototype.checkLinesRemovalInPosition = function(x, y) {
      var dirCount, dx, dy, line, linesToRemove, oppositeDirCount, startX, startY, totalCount, _i, _j, _len, _len1, _ref, _ref1, _results;
      linesToRemove = [];
